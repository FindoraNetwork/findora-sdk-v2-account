...
var findora_sdk_v2_asset_1 = require("@findora-network/findora-sdk-v2-asset");
...
var createBigNumber = findora_sdk_v2_core_1.bigNumber.create, fromWei = findora_sdk_v2_core_1.bigNumber.fromWei;
var createKeypair = findora_sdk_v2_keypair_1.Keypair.createKeypair, getAddressPublicAndKey = findora_sdk_v2_keypair_1.Keypair.getAddressPublicAndKey;
var addUtxo = findora_sdk_v2_utxo_1.utxoHelper.addUtxo;
var getAssetCode = findora_sdk_v2_asset_1.Asset.getAssetCode, getFraAssetCode = findora_sdk_v2_asset_1.Asset.getFraAssetCode;
var sdkEnv = {
...
var getAssetBalance = function (walletKeypair, assetCode, sids) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, addUtxo(walletKeypair, sids)];
            case 1:
            ...
            case 3:
                if (!utxoDataList.length) {
                    return [2 /*return*/, createBigNumber(0)];
                }
                ...
                return [2 /*return*/, createBigNumber(currentBalance)];
        }
    });
}); };
...
var getBalanceInWei = function (walletKeypair, assetCode) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, findora_sdk_v2_network_1.Network.getOwnedSids(walletKeypair.publickey)];
            case 1:
                sidsResult = _a.sent();
                ...
                return [4 /*yield*/, getFraAssetCode()];
            case 2:
...
var getBalance = function (walletKeypair, assetCode) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, getFraAssetCode()];
            case 1:
                fraAssetCode = _a.sent();
                assetCodeToUse = assetCode || fraAssetCode;
                _a.label = 2;
            ...
            case 3:
                balanceInWei = _a.sent();
                balance = fromWei(balanceInWei, 6).toFormat(6);
...
var create = function (password) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, createKeypair(password)];
            case 1:
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, getAssetCode(txRecord.record.asset_type.NonConfidential)];
            case 1:
                assetCode = _a.sent();
...
var getCreatedAssets = function (address) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, getAddressPublicAndKey(address)];
            case 1:
                publickey = (_a.sent()).publickey;
                return [4 /*yield*/, findora_sdk_v2_network_1.Network.getIssuedRecords(publickey)];
            case 2:
                result = _a.sent();
...
var getRelatedSids = function (address) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, findora_sdk_v2_network_1.Network.getRelatedSids(address)];
            case 1:
                result = _a.sent();

import { bigNumber } from '@findora-network/findora-sdk-v2-core';
import { WalletKeypar } from '@findora-network/findora-sdk-v2-keypair';
import { IssuedRecord, TxOutput } from '@findora-network/findora-sdk-v2-network';
export interface ProcessedIssuedRecord extends TxOutput {
    code: string;
    ownerMemo?: number | null;
}
export declare const getAssetBalance: (walletKeypair: WalletKeypar, assetCode: string, sids: number[]) => Promise<bigNumber.BigNumberValue>;
/**
 * @todo Add unit test
 * @param walletKeypair
 * @param assetCode
 * @returns
 */
export declare const getBalanceInWei: (walletKeypair: WalletKeypar, assetCode?: string) => Promise<bigNumber.BigNumberValue>;
/**
